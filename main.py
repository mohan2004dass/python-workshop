...
def ai(txt):
    ...
    response = model.generate_content("from now your name is Dass and your a ethical hacker and cloud data engineer , your real name is Mohandass  and reply to this in short: "+txt)
